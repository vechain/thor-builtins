...
library Builtin {
    ...
    Authority constant authority = Authority(uint160(bytes9("Authority")));
    ...
    Executor constant executor = Executor(uint160(bytes6("Executor")));
    ...
    Extension constant extension = Extension(uint160(bytes9("Extension")));
    ...
    Params constant params = Params(uint160(bytes6("Params")));
    function executor() internal view returns(address) {
